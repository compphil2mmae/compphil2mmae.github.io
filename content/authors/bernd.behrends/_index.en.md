...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:bernd.behrends9@kit.edu'
  # - icon: google-scholar
  #   icon_pack: ai
...
Bernd Behrends supports CompPhil²MMAE as a tutor in the module {{<link "philo1-ilias">}}"Einführung in die Philosophie"{{</link>}} (Introduction to philosophy) ([{{<icon name="envelope" pack="fas">}} Tutoriumsteam](mailto:tutorium.seidel@itz.kit.edu)).
