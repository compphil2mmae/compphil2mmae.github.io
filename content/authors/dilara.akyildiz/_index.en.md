...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:dilara.akyildiz@student.kit.edu'
  # - icon: google-scholar
  #   icon_pack: ai
...
Dilara Akyildiz supports CompPhil²MMAE as a student assistant and as a tutor in the module {{< link "current_ars-rationalis" >}}**Ars Rationalis**{{< /link >}}.
